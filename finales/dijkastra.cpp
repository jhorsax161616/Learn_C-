...
struct Programa
{
	...
	void cargarGrafo(Graph & graph)
	{
		for (int i = 0; i < E; ++i)
		{
			...
			cout << "-->\t" << ++n <<"|" << "- Linea \n";
			cout << "\n\t-------------------------------------" << endl;
			cout << "\n\tIngrese Origen(Punto inicial): \t";
			cin >> Origen;
			cout << "\t---------------------------------------" ;
			cout << "\n\tIngrese Destino(Punto final): \t";
			cin >> Destino;
			cout << "\n\t\t-------------------------------------------\t\t\t\n" << endl;
			cout << "\t\tIngrese Peso de la Arista(El valor): \t";
			cin >> Peso;
			cout<< "\n";
	...
	{
		cout << "Ingrese Vertice Inicial(Desde donde empieza): " << endl;
		cin >> comienzo;
		cout << "Ingrese Vertice Final(Hasta donde termina): " << endl;
		cin >> fin;
